...
************************************************************/
private["_hitpoints","_hitpoint","_limit","_available","_healthyParts","_menClose","_hasBandage","_hasEpi","_hasMorphine","_hasBlood","_vehicle","_inVehicle","_color","_part","_parts","_type","_nameType","_namePart","_nameParts"];
